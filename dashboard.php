        ...
        <div class="row">
          <a href="listed-books.php">
            <div class="col-md-4 col-sm-4 col-xs-6">
              <div
                class="shadow-hover alert alert-success back-widget-set text-center"
              >
                <i class="fa fa-book fa-5x"></i>
                <?php
                                $sql = "SELECT id from tblbooks ";
                                $query = $dbh->prepare($sql); $query->execute();
                $results = $query->fetchAll(PDO::FETCH_OBJ); $listdbooks =
                $query->rowCount(); ?>
                <h3>
          ...
          <div class="col-md-4 col-sm-4 col-xs-6">
            <div
              class="shadow-hover alert alert-warning back-widget-set text-center"
            >
              ...
              $query2->execute(); $results2 = $query2->fetchAll(PDO::FETCH_OBJ);
