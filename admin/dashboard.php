                ...
                <div class="row">
                    <a href="manage-books.php">
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <div class="shadow-hover alert alert-success back-widget-set text-center">
                    ...
                    <a href="manage-issued-books.php">
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <div class="shadow-hover alert alert-warning back-widget-set text-center">
                    ...
                    <a href="reg-students.php">
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <div class="shadow-hover alert alert-danger back-widget-set text-center">
                ...
                <div class="row">
                    ...
                    <a href="manage-categories.php">
                        <div class="col-md-3 col-sm-3 rscol-xs-6">
                            <div class="shadow-hover alert alert-info back-widget-set text-center">
